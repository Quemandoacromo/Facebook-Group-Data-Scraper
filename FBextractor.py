...
# 3. User Access Token (Steps:in PDF )
...
def user_values():
    ...
    for i in range(len(posts)):
        ...
        post_user_id=re.findall(r'span class="fwn fcg".*?ajaxify="/groups/member_bio/bio_dialog/\?group_id=\d+\&amp;member_id=(\d+)\&', post_user_id, re.MULTILINE)
